...
* **Virtual Mix-and-Match Interface:** Preview high-fashion combinations of abayas with various hijab matching styles directly on an interactive canvas.
...
* **Advanced E-Commerce Workflow:** * Add to Cart: Effortlessly manage selected garments and tailored matching pairs.
...
> **Warning** > Never commit lib/api_config.dart to GitHub. It is actively restricted inside the .gitignore configuration.
